<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Data Informasi Kelas</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card-body p-2">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            <label for="kd_kelas">Id_Kelas</label>
                            <input type="text" name="kd_kelas" value="<?= $hasilkode; ?>" placeholder="Id Kat" class="form-control" readonly>
                        </div>
